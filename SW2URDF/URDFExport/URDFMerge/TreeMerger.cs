...
public class TreeMerger
{
    ...
    public TreeMerger(
        bool useCSVInertial,
        bool useCSVVisualCollision,
        bool useCSVJointKinematics,
        bool useCSVJointOther
    )
    {
    ...
    private List<Link> MergeItems(
        ItemCollection cadCollection,
        URDFTreeCorrespondance correspondance
    )
    {
