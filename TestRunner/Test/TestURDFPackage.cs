...
{
    public TestURDFPackage(SWTestFixture fixture)
        : base(fixture) { }
    ...
    public void TestCreateDirectories()
    {
        ...
        messageBoxMock.Setup(m => m.Show(It.IsAny<string>())).Returns(MessageBoxResult.OK); //can be whatever depends on test case
